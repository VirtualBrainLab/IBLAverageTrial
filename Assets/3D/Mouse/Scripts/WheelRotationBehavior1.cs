...
public class WheelRotationBehavior1 : MonoBehaviour
{
    ...
    {
        mouseAnimator.SetBool("WheelLeft", false);
        mouseAnimator.SetBool("WheelRight", false);
    ...
    IEnumerator RotateWheel(int steps, GameObject linkedStimulus)
    {
        ...
        if (steps > 0)
            mouseAnimator.SetBool("WheelLeft", true);
        else
            mouseAnimator.SetBool("WheelRight", true);
